  ...
  override func spec() {
    describe("home cell spec") {
      ...
      beforeSuite {
        ...
        let indexPath = IndexPath(item: Int(), section: Int())
        cell = controller.dataSourceAndDelegate?.collectionView(controller.collectionView, cellForItemAt: indexPath) as? HomeCell
